...
microbitPort = '/dev/tty.usbmodem1422' # USB port address for the micro:bit /dev/ttyACM0 eller /dev/ttyACM1
...
stringToTrack = "#twittermac" # Change this to the search term you wish to track from Twitter
